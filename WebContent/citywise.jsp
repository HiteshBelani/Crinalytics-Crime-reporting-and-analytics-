...
<body>
 ...
 <header>
    ...
    <%
    String city=request.getParameter("city");//"Agra";
    String year=request.getParameter("year");//"2008";
    %>
    <br>
     <br>
    <section id="headings" class="heading">
        <div class="row">
            <div class="container crimeheading">
                <center>
                <p>
                <h4> Crime Statistics of <%=city %> for <%=year %></h4>
                </p>
                </center>
            </div>
        </div>
...
try{
	...
	PreparedStatement p=con.prepareStatement("select * from "+year+"_citywise_analysis where city_name='"+city+"' and year='"+year+"'");
...
<br>
<br>
<center><p><h4>Crimewise Ranking of <%=city %> for <%=year %></h4></p></center>
<br>

<center>
<table id="customers">
<tr>
<th><center>Crimes</center></th>
...
<%
 try {
        ...
        Connection con=ConnectionProvider.getCon();
	PreparedStatement p1=con.prepareStatement("select crimes,"+city+" from "+year+"_citywise order by crimes");
